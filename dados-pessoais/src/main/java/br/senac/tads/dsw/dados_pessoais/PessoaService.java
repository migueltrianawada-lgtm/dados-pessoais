...
public class PessoaService {
    ...
    @PostConstruct
    public void init() {
        mapPessoas.put("fulano", new Pessoa(
        ...
        mapPessoas.put("ciclano", new Pessoa(
            contador.incrementAndGet(),
            "ciclano", 
            "Ciclano de Souza",
            "ciclano@email.com", 
            "(11) 98888-5678", 
            LocalDate.parse("1999-05-10")
        ));

        mapPessoas.put("beltrana", new Pessoa(
            contador.incrementAndGet(),
            "beltrana", 
            "Beltrana dos Santos",
            "beltrana@email.com", 
            "(11) 97777-9012", 
            LocalDate.parse("2001-02-23")
        ));
    } // <- Fechamento do método init() adicionado aqui
